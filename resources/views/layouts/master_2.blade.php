...
<body>
    ...
    <!-- ======= hero Section ======= -->
    <section id="hero" style="height: 500px !important">
        <div class="hero-container">
            <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                <ol id="hero-carousel-indicators" class="carousel-indicators"></ol>
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active"
                        style="background-image: url({{ asset('homepage/img/hero-carousel/1.jpg') }})">
                    </div>
                    <div class="carousel-item"
                        style="background-image: url({{ asset('homepage/img/hero-carousel/2.jpg') }})">
                    </div>
                    <div class="carousel-item"
                        style="background-image: url({{ asset('homepage/img/hero-carousel/3.jpg') }})"></div>
                </div>
