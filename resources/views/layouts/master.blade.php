        ...
        add.forEach(function(e) {
            e.addEventListener('click', function() {
                ...
                newElement.innerHTML =
                    '<input type="text" name="list_tips[]" class="form-control input-square mt-3" placeholder="" aria-label="" aria-describedby="basic-addon1" required><button class="btn btn-danger btn-border input-group-prepend mt-3 remove_list" type="button">Remove</button>'
