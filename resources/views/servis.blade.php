...
@section('content')
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($servis as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/servis/edit/{{ $row->id_servis }}"
                                                        class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                                    <a href="#modalHapusServis{{ $row->id_servis }}" data-toggle="modal"
    ...
    @foreach ($servis as $u)
        <div class="modal fade" id="modalHapusServis{{ $u->id_servis }}" tabindex="-1" role="dialog"
