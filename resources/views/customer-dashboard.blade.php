                                ...
                                <div class="col-md-4">
                                    <div class="card" style="min-height: 450px;">
                                        <img class="card-img-top" src="{{ asset('storage/' . $item->gambar) }}"
                                            alt="Card image cap" width="214" height="140">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="well-left">
                                <div class="single-well">
                                    <div class="box">
                                        <a href="#">
                                            <img src="{{ asset('storage/' . $item->gambar) }}" class="box_img" width="300"
                                                height="300" alt="">
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    @foreach ($tips as $item)
                        <div class="col-md-3">
                            <div class="card">
                                <img class="card-img-top" src="{{ asset('storage/' . $item->gambar) }}" width="214"
                                    height="140" alt="Card image cap">
                                <div class="card-body">
